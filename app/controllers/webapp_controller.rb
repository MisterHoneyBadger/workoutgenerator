class WebappController < ActionController::Base
  ...
  def warmup
    ...
    warmshoulder = ["20 bilateral arm circles"]
  ...
  def workout
    back = ["4*10 Pullups","4*10 Chinups","5*8 Deadlifts","4*10 Dumbbell Rows","4*12 Lat Pull Downs","4*8 Seated Cable Row","50 Pullups","50 Chinups","4*8 Bicep Curls","4*8 Hammer Curls","3*20 Situps","3*20 Crunches","3*20 Leg Lifts"]
    chest = ["4*20 pushups","4*10 Bench Press","4*10 Shoulder Press","4*10 Incline Press","3*20 Situps","3*20 Crunches","3*20 Leg Lifts","60 pushups","4*10 alternating bench press","4*10 Decline press","4*15 Diamond pushups","4*15 Hindu pushups"]
    ubody = ["4*10 Pullups","4*10 Chinups","5*8 Deadlifts","4*10 Dumbbell Rows","4*12 Lat Pull Downs","4*8 Seated Cable Row","4*20 pushups","4*10 Bench Press","4*10 Shoulder Press","4*10 Incline Press","4*10 Decline press","4*15 Diamond pushups","4*15 Hindu pushups"]
